...
namespace detail
{
inline constexpr char charconv_digits[] = {'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm',
                                           'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'};
}

template <std::integral T> constexpr std::string_view to_string(T value, char *begin_buf, char *end_buf)
{
...
{
    char buffer[16]{"              "};
    return to_string(value, (char *)buffer, (char *)&buffer[15]);
}
